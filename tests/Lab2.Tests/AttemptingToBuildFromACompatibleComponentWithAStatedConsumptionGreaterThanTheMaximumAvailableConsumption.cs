...
public class AttemptingToBuildFromACompatibleComponentWithAStatedConsumptionGreaterThanTheMaximumAvailableConsumption : IEnumerable<object[]>
{
    ...
    [Theory]
    [MemberData(nameof(GetShips), MemberType = typeof(AttemptingToBuildFromACompatibleComponentWithAStatedConsumptionGreaterThanTheMaximumAvailableConsumption))]
        ...
        string nameforcard)
    {
        ...
        CheckStatus expectedValue = CheckStatus.Disclaimerofwarrantyduetoexceedingtherecommendedconsumptionofthepowersupplyunit;
