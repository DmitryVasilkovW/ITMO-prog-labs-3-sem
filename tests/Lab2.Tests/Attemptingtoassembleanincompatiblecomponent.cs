...
public class Attemptingtoassembleanincompatiblecomponent : IEnumerable<object[]>
{
    ...
    [Theory]
    [MemberData(nameof(GetShips), MemberType = typeof(Attemptingtoassembleanincompatiblecomponent))]
